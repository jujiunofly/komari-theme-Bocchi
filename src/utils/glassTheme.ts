...
const PRESET_TOKENS: Record<Exclude<GlassColorPreset, 'custom'>, GlassThemeTokens> = {
  ...
  midnight: {
    lightCard: '#ffffffd0',
    lightCardHover: '#ffffffe0',
    lightControl: '#fff5f9cc',
    lightHeader: '#fff5f9d4',
    lightText: '#3b2433',
    lightMutedText: '#7a4d62',
    lightBorder: '#ffd0e4cc',
    lightShadow: '0 14px 36px rgb(190 60 110 / 0.16), 0 4px 18px rgb(126 200 214 / 0.12)',
    darkCard: '#140812cc',
    darkCardHover: '#1c0c16e6',
